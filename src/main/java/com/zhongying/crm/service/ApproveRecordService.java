...
public class ApproveRecordService {
	...
	public List<ApproveRecord> queryRiZhi1(String startDate, String endDate, Integer customerId) {
		// TODO Auto-generated method stub
		return approveRecordMapper.queryRiZhi1( startDate,  endDate, customerId);
	}
