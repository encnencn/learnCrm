    ...
    var adminManager = {
       ...
       updateCheckMobile:function(){
        ...
        updateCheckAdminName:function(){
        	 ...
        	 var that = this;
             $("#myModalUpdate").on('input', '#form-field-username', function() {
      ...
      //添加用户时候校验用户名
        ...
        addCheckAdminName:function(){
        	 ...
        	 var that = this;
             $("#myModalAdd").on('input', '#form-field-username', function() {
...
//               }
        ...
        queryAdmin:function(){
            ...
            $(".queryNotice").on('click', '.btn-primary', function() {
              ...
              var name = $(this).parents('.modal-content').find('#form-field-name').val();
              if(name==""){
                  $(this).parents('.modal-content').find('#form-field-name').focus();
                          return false;
               }
                $.ajax({
                  url : "/queryByTrueName",
